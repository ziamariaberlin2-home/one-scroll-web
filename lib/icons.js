...
// the site's wine/cream palette rather than clashing with it.
import {
  Flame,
  Sprout,
  Leaf,
...
export const FEATURE_ICONS = {
  ...
  staffing: { Icon: ClipboardList, color: '#8B4B2E' },
