...
export const blogPosts = [
  {
    ...
    body: [
      ...
      {
        type: 'p',
        text: 'Our dough is slow-fermented and thin, so a slice is a real meal, not a nibble. Two of those and most guests are genuinely full. That works out to roughly 2 pizzas for every 3 people, simple enough to do the math on the spot.',
      },
